...
const Footer = () => {
  const socialLinks = [
    { icon: <FaGithub />, url: "https://github.com/creativeabhishek" },
    { icon: <FaLinkedin />, url: "https://linkedin.com/in/creativeabhishek" },
    { icon: <FaTwitter />, url: "https://twitter.com/creativeabhishek" },
    { icon: <FaInstagram />, url: "https://instagram.com/creativeabhishek" },
  ...
  return (
    <footer className="bg-gradient-to-t from-gray-900 to-black text-white pt-16 pb-8 px-4 sm:px-6">
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-2 rounded-md bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 bg-gradient-to-r from-yellow-400 to-red-500 text-black font-semibold rounded-md"
              >
                Subscribe
              </motion.button>
            </motion.div>
